...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center px-6 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 bg-slate-900/60 border border-slate-700/50 p-10 rounded-2xl shadow-xl backdrop-blur-lg">
        <button
          onClick={() => navigate("/")}
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">
            Welcome to <span className="text-blue-400">Seven</span>
          </h1>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-slate-800/50 hover:bg-slate-800/70 border border-slate-700/50 rounded-xl text-white font-medium transition-all duration-200 shadow-lg hover:shadow-blue-500/25"
        >
        ...
        <p className="text-center text-xs text-slate-500 mt-6">
          ...
          <button className="text-slate-400 hover:text-white underline">
            Terms
          </button>{" "}
          and{" "}
          <button className="text-slate-400 hover:text-white underline">
